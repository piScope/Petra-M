...
class Engine(object):
    ...
    def run_assemble_MBX_blocks(self, compute_A, compute_rhs,
    ...
    def initialize_phys(self, phys):
        ...
        for j in range(self.n_matrix):
            ...
            self.gf_allocator[(j, phys.name())] = GF_allocator()
            self._gfa = self.gf_allocator[(j, phys.name())]
